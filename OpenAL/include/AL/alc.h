...
/** Context attribute: <int> requested Mono (3D) Waves. */
#define ALC_MONO_SOURCES                         0x1010

/** Context attribute: <int> requested Stereo Waves. */
...
/** RangedNumber of sample frames available for capture. */
 ...
 */
ALC_API ALCdevice*
ALC_APIENTRY alcCaptureOpenDevice(const ALCchar* devicename, ALCuint frequency, ALCenum format, ALCsizei buffersize);
...
typedef void           (ALC_APIENTRY* LPALCGETINTEGERV)(ALCdevice* device, ALCenum param, ALCsizei size,
														ALCint* values);
typedef ALCdevice* (ALC_APIENTRY* LPALCCAPTUREOPENDEVICE)(const ALCchar* devicename, ALCuint frequency, ALCenum format,
														  ALCsizei buffersize);
